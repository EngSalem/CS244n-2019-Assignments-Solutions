...
def minibatch_parse(sentences, model, batch_size):
    ...
    while len(unfinished_parses) > 0:
          ...
          predicted_transitions_batch = model.predict(batch_parses)
          
          ## apply transitions to batch
          for transitions, sent in zip(predicted_transitions_batch, unfinished_parses):
              sent.parse(list(transitions))
