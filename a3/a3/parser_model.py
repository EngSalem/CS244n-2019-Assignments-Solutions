...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        nn.self.embed_to_hidden = nn.Linear(self.embed_size*self.n_features, self.hidden_size)
    ...
    def forward(self, t):
        ...
        activations = F.relu(embed_to_hidden)
        drop_outs = self.dropout(activations)
        logits = self.hidden_to_logits(drop_outs)  
        return logits
